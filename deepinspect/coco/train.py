...
def main():
    ...
    parser.add_argument('--ann_dir', type=str, default='/home/tyc/Downloads/cocodataset/annotations',
                        help='path for annotation json file')
    parser.add_argument('--image_dir', default = '/home/tyc/Downloads/cocodataset')
