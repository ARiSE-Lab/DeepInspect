...
def get_yhats_test():
    model = select_model('large')
    model_name = 'model/cifar_large_robust_new.h5'
...
def get_channel_coverage_group_exp(self, input, output):
    ...
    if len(globalcoverage[-1]["layercoverage"]) == 7:
        with open('globalcoveragecifarexp_large_test_'+str(gthreshold)+'.pickle', 'ab') as handle:
...
def get_10_csv_files(sample_10):
    ...
    with open('robust_cifar_large_test_labels_10.csv', 'wb',0) as csvfile1:
    ...
    with open('robust_cifar_large_test_predicted_labels_10.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    ...
    with open('robust_cifar_large_objects_directional_type1_confusion_test_10.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
...
def get_90_csv_files(sample_10):
    ...
    with open('robust_cifar_large_test_labels_90.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    ...
    with open('robust_cifar_large_test_predicted_labels_90.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    ...
    with open('robust_cifar_large_objects_directional_type1_confusion_test_90.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
...
def deepinspect(sample_10):
    ...
    infile = open('globalcoveragecifarexp_large_test_'+str(gthreshold)+'.pickle', 'r')
    processed = 0
    while 1:
        try:
    ...
    with open('robust_cifar_large_neuron_distance_from_predicted_labels_test_90_'+str(gthreshold)+'.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
