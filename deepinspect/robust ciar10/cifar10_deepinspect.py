...
def get_channel_coverage_group_exp(self, input, output):
    ...
    for c in xrange(len(covered_channel_group)):
        ...
        assert len(globalcoverage[d]["layercoverage"]) <= 4
    ...
    if len(globalcoverage[-1]["layercoverage"]) == 4:
...
def read_coverage_dump_probability_test_predicted():
    ...
    infile = open('globalcoveragecifarexp_small_test_0.25.pickle', 'r')
    processed = 0
    while 1:
        try:
    ...
    p_feature_sensitivity = copy.deepcopy(layer_coverage)
    for l in xrange(total_layers):
        for n in layer_coverage[l].keys():
            for v in layer_coverage[l][n].keys():
                p_feature_sensitivity[l][n][v] = p_feature_sensitivity[l][n][v]*1.0 / activation_sum[l][n]




    with open('cifar_p_layer_coverage_predicted.pickle', 'wb') as handle:
        pickle.dump(p_layer_coverage, handle, protocol=pickle.HIGHEST_PROTOCOL)

    with open('cifar_p_feature_sensitivity_predicted.pickle', 'wb') as handle:
        pickle.dump(p_feature_sensitivity, handle, protocol=pickle.HIGHEST_PROTOCOL)
...
def get_10_csv_files(sample_10):
    ...
    with open('robust_cifar_small_test_labels_10.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    ...
    with open('robust_cifar_small_test_predicted_labels_10.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    ...
    with open('robust_cifar_small_objects_directional_type1_confusion_test_10.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
...
def get_90_csv_files(sample_10):
    ...
    with open('robust_cifar_small_test_labels_90.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    ...
    with open('robust_cifar_small_test_predicted_labels_90.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    ...
    with open('robust_cifar_small_objects_directional_type1_confusion_test_90.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
...
def read_coverage_dump_probability_test_predicted_90(sample_10):
    ...
    infile = open('globalcoveragecifarexp_small_test_'+str(gthreshold)+'.pickle', 'r')
    processed = 0
    while 1:
        try:
            globalcoverage = pickle.load(infile)
    ...
    with open('robust_cifar_small_neuron_distance_from_predicted_labels_test_90_'+str(gthreshold)+'.csv', 'wb',0) as csvfile1:
        writer = csv.writer(csvfile1, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
