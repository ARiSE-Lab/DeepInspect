...
```
## 2. DeepInspect
Generating neuron coverage and computing probability matrix may take longer time. It is recommended to run the CIFAR-10 script if reading DeepInspect first time to get a general idea, set up the environment and be familiar with the whole workflow.
